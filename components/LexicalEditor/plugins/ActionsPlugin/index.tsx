...
export default function ActionsPlugin({
  ...
  return (
    <div className="actions">
      ...
      >
        <i className={`${!isEditable ? "unlock" : "lock"}  scale-75`} />
      </button>
      <button
